...
class ConfirmationPage extends StatefulWidget {
  ...
  @override
  _ConfirmationPageState createState() => _ConfirmationPageState(prize);
}
...
class _ConfirmationPageState extends State<ConfirmationPage> {
  ...
  _ConfirmationPageState(prize) {
    API().getCurrentUserData().then(
      (value) {
        prizeInfo = prize;
        currentUser = value;
        purchaseInfo = currentUser.pendingPurchasedItems[prizeInfo.prizeId]!;
        expirationDate = purchaseInfo[0];
        confirmationCode = purchaseInfo[1];
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  InkWell(
                                    onTap: () {
                                      // if prev page is shop, pop shop page and push replacement to it
                                      // else pop context
                                      if (true) {
                            ...
                            Padding(
                              padding:
                                  EdgeInsetsDirectional.fromSTEB(30, 0, 25, 0),
                              child: Row(
                                mainAxisSize: MainAxisSize.max,
                                children: [
                                  Container(
